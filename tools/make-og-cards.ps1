...
$pages = @(
  ...
  @{ file="projects.png";        kicker="Projects";             title="Apps, mods && bots";    sub="Mayflower Idle RPG, Mayflower Radio, Minecraft Forge mods, and cozy Discord bots.";               accent=$COL.violet;  art="$icons\favicon.png" }
  ...
  @{ file="bots__foxbot.png";    kicker="Discord bot";          title="FoxBot";               sub="Kiko — a cozy fennec-fox AI helper for Luna's Magical Forest.";                                   accent=$COL.gold;    art="$icons\foxbot.png" }
  @{ file="bots__echobloom.png"; kicker="Discord RPG bot";      title="EchoBloom";            sub="A blooming text-RPG with classes, quests, world events, and a bestiary.";                         accent=$COL.rose;    art="$icons\echobloom.png" }
