...
$pages = @(
  ...
  @{ file="projects.png";        kicker="Projects";             title="Apps, mods && Bots"; sub="Mayflower Idle RPG, Mayflower Radio, Minecraft Forge mods, and Discord bots.";                          accent=$COL.violet;  art="$icons\favicon.png" }
